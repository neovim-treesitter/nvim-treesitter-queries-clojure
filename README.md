...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-clojure/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-clojure/actions/workflows/validate.yml)

Neovim tree-sitter queries for **clojure**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-clojure",
...
- [ ] Changes are scoped to `clojure` — do not include files for other languages
